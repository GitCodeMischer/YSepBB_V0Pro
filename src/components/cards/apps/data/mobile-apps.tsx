...
export const mobileApps: AppItemType[] = [
  {
    title: "YSepBB",
    description:
      "YSepBB revolutionizes finance management with AI. Track expenses, optimize budgets, and achieve financial goals effortlessly.",
    icon: "/works/ysepbb/logo.ico",
    image: "/works/ysepbb/logo.jpg",
    appstore: "",
    playstore: "",
    path: "/gymtracker",
    keywords: [
    ...
    tags: ["#FinancialPlanning", "#Budgeting", "#PersonalFinance", "#ExpenseTracking"],
    hasBorder: true
  },
  {
    title: "MealMetterPrePro",
    description:
      "Simplifying meal planning for healthier living. Enjoy effortless, personalized meal suggestions tailored to your preferences, promoting a balanced lifestyle with every bite.",
    icon: "/works/mealmetterprepro/logo.ico",
    image: "/works/mealmetterprepro/logo.jpeg",
    appstore: "",
    playstore: "",
    path: "/radio",
    keywords: [
